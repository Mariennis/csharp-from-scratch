namespace itm.csharp.basic
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Hola, {nombre}! Por favor, elige un ejercicio del siguiente menu:");
            Menu.MostrarMenu();
            while (true)
            {
                ...
                {
                    //Agregar la logica del swtich con las funciones de los ejercicios
                    ...
                    Console.WriteLine("Presiona unaa tecla para continuar");
                    Console.ReadLine();
                    Console.ReadKey();
                    Console.Clear;
                    Menu.MostrarMenu();
